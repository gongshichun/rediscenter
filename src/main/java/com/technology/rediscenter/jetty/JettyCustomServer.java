...
import com.technology.rediscenter.util.StringUtils;
...
public class JettyCustomServer extends Server {
    ...
    public JettyCustomServer(String xmlConfigPath, String contextPath, String resourceBase,
                             String webXmlPath) {
    ...
    public JettyCustomServer(String xmlConfigPath, String contextPath, String resourceBase,
                             String webXmlPath, String warPath) {
        super();
    ...
    private void readXmlConfig() {
        try {
            XmlConfiguration configuration =
                new XmlConfiguration(new FileInputStream(this.xmlConfigPath));
    ...
    public void applyHandle(Boolean warDeployFlag) {
        ...
        webapp.setDefaultsDescriptor("./config/jetty/webdefault.xml");
    ...
    public void startServer() {
        try {
            ...
            System.out.println("current thread:"
                + super.getThreadPool().getThreads()
                + "| idle thread:"
